(function(){"use strict";try{if(typeof document<"u"){var o=document.createElement("style");o.appendChild(document.createTextNode('@keyframes rotate-b07d1d2b{0%{transform:rotate(0)}to{transform:rotate(360deg)}}div.error[data-v-b07d1d2b]{display:flex;align-items:center;justify-content:center;min-height:200px;border:1px solid #eee;background-color:#f9f9f9;border-radius:10px}figure.image-zoom[data-v-b07d1d2b]{position:relative;display:inline-block;width:auto;min-height:25vh;background-position:50% 50%;background-color:#eee;margin:0;overflow:hidden;-webkit-user-select:none;user-select:none;cursor:zoom-in}figure.image-zoom.loaded[data-v-b07d1d2b]{min-height:auto}figure.image-zoom.zoomed[data-v-b07d1d2b]{cursor:zoom-out}figure.image-zoom[data-v-b07d1d2b]:before{content:"";background-color:transparent;position:absolute;top:0;left:0;right:0;width:100%;height:100%;opacity:1;transition:opacity .2s ease-in-out;z-index:1}figure.image-zoom[data-v-b07d1d2b]:after{content:"";position:absolute;top:calc(50% - 25px);left:calc(50% - 25px);width:50px;height:50px;border-radius:50%;border:5px solid transparent;border-top-color:#333;border-right-color:#333;border-bottom-color:#333;opacity:1;animation:rotate-b07d1d2b 2s linear infinite;transition:opacity .2s ease-in-out;z-index:2}figure.image-zoom.loaded[data-v-b07d1d2b]:before,figure.image-zoom.loaded[data-v-b07d1d2b]:after{opacity:0}figure.image-zoom img[data-v-b07d1d2b]{opacity:1;display:block}figure.image-zoom.zoomed img[data-v-b07d1d2b]{opacity:0}')),document.head.appendChild(o)}}catch(e){console.error("vite-plugin-css-injected-by-js",e)}})();
...
const j = ["id", "aria-label"], q = ["src", "alt", "width", "height"], A = /* @__PURE__ */ x({
  ...
  for (const [e, o] of i)
    n[e] = o;
  return n;
}, J = /* @__PURE__ */ G(A, [["__scopeId", "data-v-b07d1d2b"]]), Q = (t) => {
